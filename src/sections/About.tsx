...
export default function About() {
  ...
  const tlEvents = [
    ...
    { title: "🚀 Hackathon Kickoff",    date: "April 15, 2026",          desc: "Let the hacking begin! 48 hours of pure coding creativity and innovation.",                                      status: "upcoming"  as const, statusLabel: "Coming Soon 👀" },
