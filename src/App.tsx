...
function Navbar({ onNavClick }: { onNavClick: (e: React.MouseEvent<HTMLAnchorElement>) => void }) {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 flex flex-col shadow-[0_6px_0px_#1a1a1a]">
      <Marquee />
      <div className="w-full border-b-[6px] border-[#1a1a1a] bg-[#f3ecd2] px-4 md:px-8 py-4 md:py-5 flex justify-between items-center relative">
        ...
        <div className="hidden md:flex gap-10 font-bold text-xl uppercase tracking-widest text-[#1a1a1a]">
          <a href="#hero" onClick={handleLinkClick} className="hover:text-[#f489a3] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">Schedule</a>
          <a href="#timeline" onClick={handleLinkClick} className="hover:text-[#f97028] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">Timeline</a>
          <a href="#themes" onClick={handleLinkClick} className="hover:text-[#f3a20f] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">Themes</a>
          <a href="#about" onClick={handleLinkClick} className="hover:text-[#ff8a3d] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">About</a>
          <a href="#speakers" onClick={handleLinkClick} className="hover:text-[#f3a20f] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">Speakers</a>
          <a href="#faq" onClick={handleLinkClick} className="hover:text-[#ff5ea8] hover:underline decoration-[4px] underline-offset-8 transition-colors drop-shadow-[1px_1px_0px_#1a1a1a]">FAQ</a>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <a href="#hero" onClick={handleLinkClick} className="hover:text-[#f489a3]">Schedule</a>
            ...
            <a href="#speakers" onClick={handleLinkClick} className="hover:text-[#f3a20f]">Speakers</a>
