...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  position = 'right',
  colors = ['#f97028', '#f489a3', '#f3a20f', '#5d275d'],
  items = [
    { label: 'Main', ariaLabel: 'Go to Main section', link: '#hero' },
    { label: 'Themes', ariaLabel: 'Go to Themes section', link: '#themes' },
    { label: 'Prizes', ariaLabel: 'Go to Prizes section', link: '#prizes' },
  ...
  const handleItemClick = (e: React.MouseEvent<HTMLAnchorElement>, link: string) => {
    if (link.startsWith('#')) {
      e.preventDefault();
      closeMenu();
